...
public class MonthFunction implements IFunction {
    ...
    public Column[] getColumns() {
        return new Column[]{
                new Column(null, ParadoxType.INTEGER, 0, 4, "The month (a number from 1 to 12).", 0, false,
                        DatabaseMetaData.functionColumnResult),
                new Column("date", ParadoxType.TIMESTAMP, 0, 11, "The time/datetime to extract the month from.", 1,
