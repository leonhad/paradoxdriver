...
public class MonthFunction extends AbstractDateFunction {
    ...
    public Column[] getColumns() {
        return new Column[]{
                new Column(null, ParadoxType.INTEGER, "The month (a number from 1 to 12).", 0, false,
                        DatabaseMetaData.functionColumnResult),
                new Column("date", ParadoxType.TIMESTAMP, "The time/datetime to extract the month from.", 1,
