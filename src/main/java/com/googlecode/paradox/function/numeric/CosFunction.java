...
/**
 * The SQL COS functions.
 *
 * @version 1.2
 * @since 1.6.0
 */
public class CosFunction extends AbstractNumericFunction {
    ...
    private static final Column[] COLUMNS = {
            new Column(null, ParadoxType.NUMBER, "The the cosine of a number.", 0, false, RESULT),
