...
/**
 * The SQL ARC-COT functions.
 *
 * @since 1.6.0
 */
public class ACotFunction extends AbstractNumericFunction {
    ...
    private static final Column[] COLUMNS = {
            new Column(null, ParadoxType.NUMBER, "The the arc-cotangent of a number.", 0, false, RESULT),
    ...
    public Object execute(final ConnectionInfo connectionInfo, final Object[] values, final ParadoxType[] types, final FieldNode[] fields) {
        ...
        double rads = 1.0 / Math.tan(value);
