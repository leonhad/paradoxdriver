...
class ParadoxPreparedStatement extends ParadoxStatement implements PreparedStatement {
     ...
     */
    protected final List<int[]> executionTypes = new ArrayList<>();
    /**
     * Parameter list.
     */
     ...
     * Parameter type list.
     */
    private final int[] currentParameterTypes;
    ...
    ParadoxPreparedStatement(final ParadoxConnection connection, final String sql, final int resultSetType,
        ...
        currentParameterTypes = new int[statements.get(0).getParameterCount()];
    }
    ...
    protected int[] executeStatements() throws SQLException {
        ...
        for (final StatementNode statement : statements) {
            ...
            for (int i = 0; i < executions.size(); i++) {
                ...
                final int[] types = executionTypes.get(i);
    ...
    public void setNull(int parameterIndex, int sqlType) throws SQLException {
        ...
        currentParameterTypes[parameterIndex - 1] = sqlType;
    }
    ...
    public void setBoolean(int parameterIndex, boolean x) throws SQLException {
        ...
        currentParameterTypes[parameterIndex - 1] = Types.BOOLEAN;
    }
    ...
    public void setByte(int parameterIndex, byte x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.INTEGER;
    }
    ...
    public void setLong(int parameterIndex, long x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.NUMERIC;
    }
    ...
    public void setString(int parameterIndex, String x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.VARCHAR;
    }
    ...
    public void setBytes(int parameterIndex, byte[] x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.BLOB;
    }
    ...
    public void setDate(int parameterIndex, Date x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.DATE;
    }
    ...
    public void setTime(int parameterIndex, Time x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.TIME;
    }
    ...
    public void setTimestamp(int parameterIndex, Timestamp x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.TIMESTAMP;
    }
    ...
    public void setAsciiStream(int parameterIndex, InputStream x, int length) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.CLOB;
    }
    ...
    public void setObject(int parameterIndex, Object x, int type) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = type;
    }
    ...
    public void setObject(int parameterIndex, Object x) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = Types.JAVA_OBJECT;
    }
    ...
    public void setObject(int parameterIndex, Object x, int targetSqlType, int scaleOrLength) throws SQLException {
        checkIndex(parameterIndex);
        currentParameterValues[parameterIndex - 1] = x;
        currentParameterTypes[parameterIndex - 1] = targetSqlType;
