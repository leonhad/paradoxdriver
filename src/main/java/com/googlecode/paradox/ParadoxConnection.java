...
public final class ParadoxConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(final String sql, final int resultSetType,
        ...
        final ParadoxPreparedStatement statement = (ParadoxPreparedStatement) prepareStatement(sql);
    ...
    public PreparedStatement prepareStatement(final String sql, final int autoGeneratedKeys) throws SQLException {
        final PreparedStatement statement = new ParadoxPreparedStatement(this, sql, autoGeneratedKeys);
    ...
    public PreparedStatement prepareStatement(final String sql, final int resultSetType, final int resultSetConcurrency,
        ...
        statement.setResultSetConcurrency(resultSetConcurrency);
        statement.setResultSetType(resultSetType);
        statement.setResultSetHoldability(holdability);
        return statement;
    }
