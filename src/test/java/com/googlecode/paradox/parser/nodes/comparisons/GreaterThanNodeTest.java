/*
 * GreaterThanNodeTest.java 07/17/2009 Copyright (C) 2009 Leonardo Alves da Costa This program is free software: you can
...
public class GreaterThanNodeTest {
    ...
    public void testToString() {
        ...
        final GreaterThanNode node = new GreaterThanNode(first, last);
