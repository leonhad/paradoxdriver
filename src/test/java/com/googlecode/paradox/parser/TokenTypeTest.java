...
public class TokenTypeTest {
     ...
     */
    private static final TokenType[] CONDITIONAL_BREAKS = { TokenType.ORDER, TokenType.HAVING, TokenType.RPAREN, TokenType.LEFT, TokenType.RIGHT, TokenType.OUTER, TokenType.INNER, TokenType.JOIN };
    ...
    public void testOperators() {
        for (final TokenType token : TokenType.values()) {
            ...
            Assert.assertEquals(test, TokenType.isOperator(token));
        }
    }
